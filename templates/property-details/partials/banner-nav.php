...
$active_tab = advmls_option('prop_default_active_tab', 'image_gallery');
...
<ul class="nav nav-pills" id="pills-tab" role="tablist">
	<li class="nav-item">
		...
		<?php if( !advmls_map_in_section() && advmls_get_listing_data('property_map') ) { ?>
		...
		<?php } ?>
			<i class="advmls-icon icon-picture-sun"></i>
		</a>
	</li>
	...
	<?php if( !advmls_map_in_section() && advmls_get_listing_data('property_map')) { ?>
		<li class="nav-item">
			<a class="nav-link <?php echo esc_attr($map_active); ?>" id="pills-map-tab" data-toggle="pill" href="#pills-map" role="tab" aria-controls="pills-map" aria-selected="true">
				<i class="advmls-icon icon-maps"></i>
			</a>
		</li>

		<?php if( advmls_get_map_system() == 'google' && $map_street_view != 'hide' ) { ?>
		<li class="nav-item">
			<a class="nav-link <?php echo esc_attr($street_active); ?>" id="pills-street-view-tab" data-toggle="pill" href="#pills-street-view" role="tab" aria-controls="pills-street-view" aria-selected="false">
				<i class="advmls-icon icon-location-user"></i>
			</a>
		</li>
		<?php } ?>
	<?php } ?>
