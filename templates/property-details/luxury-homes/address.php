<?php
$google_map_address = advmls_get_listing_data('property_map_address');
...
<div class="fw-property-address-wrap fw-property-section-wrap" id="property-address-wrap">
	<div class="block-wrap">
		<div class="block-title-wrap">
			<h2><?php echo advmls_option('sps_address', 'Address'); ?></h2>
		...
		<div id="advmls-single-listing-map" class="block-map-wrap">
