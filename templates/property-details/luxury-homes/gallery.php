...
<div class="fw-property-gallery-wrap fw-property-section-wrap" id="property-gallery-wrap">
	<div class="row row-no-padding">
		...
		foreach( $properties_images as $prop_image_id => $prop_image_meta ) { $i++;
            $full_image = advmls_get_image_by_id( $prop_image_id, 'full' ); ?>

	        <div class="col-md-3 col-sm-6">
				<a href="#" data-slider-no="<?php echo esc_attr($i); ?>" class="advmls-trigger-popup-slider-js swipebox hover-effect" data-toggle="modal" data-target="#property-lightbox">
