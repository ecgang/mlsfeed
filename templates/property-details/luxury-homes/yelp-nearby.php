...
<div class="fw-property-nearby-wrap fw-property-section-wrap" id="property-nearby-wrap">
	<div class="block-wrap">
		<div class="block-title-wrap d-flex justify-content-between align-items-center">
			...
			<div class="small-text nearby-logo"><?php echo esc_html__("Powered by", "advmls"); ?> <i class="advmls-icon icon-social-media-yelp"></i> <strong><?php echo esc_html__("Yelp", "advmls"); ?></strong></div>
