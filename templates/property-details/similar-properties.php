<?php
$show_similer = advmls_option( 'advmls_similer_properties' );
$similer_criteria = advmls_option( 'advmls_similer_properties_type', array( 'property_type', 'property_city' ) );
$listing_view = advmls_option( 'advmls_similer_properties_view' );
$similer_count = advmls_option( 'advmls_similer_properties_count' );
...
if( $show_similer ) {
	...
	$sort_by = advmls_option( 'similar_order', 'd_date' );
	if ( $sort_by == 'a_price' ) {
	...
	if ($wp_query->have_posts()) : ?>
		<div id="similar-listings-wrap" class="similar-property-wrap <?php echo esc_attr($wrap_class); ?>">
			<div class="block-title-wrap">
				<h2><?php echo advmls_option('sps_similar_listings', 'Similar Listings'); ?></h2>
