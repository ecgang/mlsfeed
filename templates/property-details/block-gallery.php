...
$visible_images = advmls_option('block_gallery_visible', 9);
$images_in_row = advmls_option('block_gallery_columns', 3);;
...
<div class="property-gallery-grid property-section-wrap" id="property-gallery-grid">        
    <div class="d-flex flex-wrap">
        ...
        ?>
        <a data-toggle="modal" data-slider-no="<?php echo esc_attr($i); ?>" data-target="#property-lightbox" class="advmls-trigger-popup-slider-js gallery-grid-item <?php if($i == $visible_images && $remaining_images > 0 ){ echo 'more-images'; } elseif($i > $visible_images) {echo 'gallery-hidden'; } ?>">
