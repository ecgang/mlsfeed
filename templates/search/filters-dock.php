...
$enable_radius_search = advmls_option('dock_radius_search');
if($enable_radius_search != 1) {
	unset($layout['geolocation']);
}

if( advmls_option('dock_price_range') ) {
...
if(wp_is_mobile()) { 
	...
	$advanced_fields = array_slice($layout, advmls_option('dock_search_top_row_fields'));
}
...
<div class="advanced-search-filters search-v1-v2">
	...
	<?php if( advmls_option('dock_price_range') ) { ?>
	<div class="d-flex">
...
<?php 
if( advmls_option('dock_search_other_features') ) {
