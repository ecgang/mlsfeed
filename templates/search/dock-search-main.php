<?php
$dock_search_enable = advmls_option('enable_advanced_search_over_headers');
$search_over_header_pages = advmls_option('adv_search_over_header_pages');
$search_selected_pages = advmls_option('adv_search_selected_pages');
