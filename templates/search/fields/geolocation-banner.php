...
<div class="form-group">
	<div class="location-search hz-map-field-js" data-address-field="search_location_banner">
		<input name="search_location" id="search_location_banner" type="text" class="search_location_js form-control" value="<?php echo esc_attr($search_location); ?>" placeholder="<?php echo advmls_option('srh_location', 'Location'); ?>">
