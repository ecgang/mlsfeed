...
if( advmls_option('enable_disable_save_search', 0) ) {
?>
<div class="save-search-form-wrap">
    ...
    <?php } ?>
        ...
        <input type="hidden" name="advmls_save_search_ajax" value="<?php echo wp_create_nonce('advmls-save-search-nounce')?>">

        <button id="save_search_click" class="btn save-search-btn" type="button">
            <?php get_template_part('template-parts/loader'); ?>
            <i class="advmls-icon icon-alarm-bell mr-1"></i> <?php echo advmls_option('srh_btn_save_search', 'Save Search'); ?>
        </button>
    <?php if( !advmls_is_half_map() ) { ?>
    </form>
    <?php } ?>
