...
if(advmls_option('agent_tabs', 1)) {
    ...
    $agent_detail_tab_1 = advmls_option('agent_detail_tab_1');
    $agent_detail_tab_2 = advmls_option('agent_detail_tab_2');

    if(!empty($agent_detail_tab_1) || !empty($agent_detail_tab_2)) {

    $tab_1 = advmls_get_term_by( 'term_id', $agent_detail_tab_1, 'property_status' );
    $tab_2 = advmls_get_term_by( 'term_id', $agent_detail_tab_2, 'property_status' );
    ...
    <ul class="nav nav-tabs">
        <li class="nav-item">
            <a class="nav-link <?php echo esc_attr( $tab_all ); ?>" href="<?php echo esc_url($all_link); ?>"><?php esc_html_e('All', 'advmls');?></a>
        </li>
