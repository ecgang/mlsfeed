...
<div class="item-listing-wrap hz-item-gallery-js item-listing-wrap-v6 card" <?php advmls_property_gallery('advmls-item-image-6'); ?>>
			...
			<div class="item-header">
				...
				<div class="listing-image-wrap">
					<div class="listing-thumb">
						...
						<?php
						$thumbnail_size = !empty($ele_thumbnail_size) ? $ele_thumbnail_size : 'advmls-item-image-6';

					    if( has_post_thumbnail( $post->ID ) && get_the_post_thumbnail($post->ID) != '' ) {
					        the_post_thumbnail( $thumbnail_size, array('class' => 'img-fluid') );
					    }else{
					        advmls_image_placeholder( $thumbnail_size );
					    }
					    ?>
						</a>
					</div>
			...
			<div class="item-body flex-grow-1">
				...
				<div class="d-flex justify-content-between align-items-center amenities-price-wrap">
					<ul class="item-price-wrap">
						<li class="item-price"><?php echo advmls_listing_price_v5(); ?></li>
					</ul>
