...
?>
<div class="item-listing-wrap hz-item-gallery-js item-listing-wrap-v5 card" <?php advmls_property_gallery('advmls-item-image-1'); ?>>
		...
		<div class="d-flex align-items-center h-100">
			...
			<div class="item-body flex-grow-1">
				...
				<div class="item-v5-price">
					<?php echo advmls_listing_price_v5(); ?>
				</div>

				<?php if(!empty($property_type) && advmls_option('disable_type', 1)) { ?>
