<?php
global $post, $total_listing_found, $advmls_local, $listings_tabs;
...
$tab_1 = advmls_get_term_by( 'slug', $listings_tab_1, 'property_status' );
$tab_2 = advmls_get_term_by( 'slug', $listings_tab_2, 'property_status' );
...
$property_label = advmls_option('cl_property', 'Property');
if( $total_listing_found > 1 ) {
   $property_label = advmls_option('cl_properties', 'Properties'); 
}
?>
<div class="listing-tabs flex-grow-1">
    ...
    if($listings_tabs != 'disable') {
        ...
        <ul class="nav nav-tabs">
            <li class="nav-item">
                <a class="nav-link <?php echo esc_attr( $tab_all ); ?>" href="<?php echo esc_url( $listing_page_link ); ?>"><?php echo esc_html__('All', 'advmls'); ?></a>
            </li>
